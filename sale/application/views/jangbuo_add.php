...
<html lang= "en">
  ...
  <body>
    ...
    <table class="table table-bordered table-sm mymargin5">
        ...
        <tr>
            ...
            <td width="80%" align="left">
                <div class="form-inline">
                    ...
                    <input type="text" name="product_name" value="" class="form-control-sm" disabled>
        ...
        <tr>
            <td width="20%" class="info" style="vertical-align:middle"><font color="red">*</font>매출수량</td>
            <td width="80%" align="left">
                <div class="form-inline">
                    <input type="text" name="numo" value="" class="form-control form-control-sm" onChange="select_product();">
                </div>
            </td>
        </tr>
