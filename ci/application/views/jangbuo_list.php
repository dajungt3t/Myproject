...
<html lang= "en">
  ...
  <script>
    function find_text() {
      form1.action="/ci/jangbuo/lists/text1/" + form1.text1.value;
      form1.submit();
    }
    ...
    $(function() {
      ...
      ?>
        ...
        <a href="/ci/jangbuo/add<?=$tmp?>" class="btn btn-sm mycolor1">추가</a>
    ...
    <table class="table table-bordered mymarigin5">
      ...
      <td><?=$no?></td>
      <td><?=$row->date?></td>
      <td align="left"><a href= "/ci/jangbuo/view/no/<?=$no?><?=$tmp?>"><?=$row->product_name;?></a></td>
