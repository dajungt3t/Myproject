...
<html lang= "en">
  ...
  <body>
    ...
    <table class="table table-bordered table-sm mymargin5">
        ...
        <tr>
            <td width="20%" class="info" style="vertical-align:middle">재고</td>
            <td width="80%" align="left">
                <div class="form-inline">
                    <?=$row->jaego;?>
                </div>
        ...
        <tr>
            <td width="20%" class="info" style="vertical-align:middle">사진</td>
            <td width="80%" align="left">
                <?php if($row->pic) { ?>
    ...
    <div align="center">
        <a href="/ci/product/edit<?=$tmp;?>" class="btn btn-sm mycolor1">수정</a>
        <a href="/ci/product/del<?=$tmp;?>" class="btn btn-sm mycolor1" onclick="return confirm('삭제하시겠습니까?');">삭제</a>
